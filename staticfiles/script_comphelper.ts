class CompareUtil
{
    static sortcompare(a: any, b: any, key: string): number
    {
    ...
    static sortcompareData(a: any, b: any, key: string): number
    {
        const va = a.data[key];
        const vb = b.data[key];
    ...
    static sortcompareMeta(a: any, b: any, key: string): number
    {
        const va = a.meta[key];
        const vb = b.meta[key];
    ...
    static sortcompareValues(va: any, vb: any): number
    {
        ...
        {
            if (va.length > 0 && vb.length > 0) return this.sortcompareValues(va[0], vb[0]);
    ...
    static sortcompareDiv(a: any, b: any, key1: string, key2: string): number
    {
